...
class LearningRules extends Table {
  ...
  TextColumn get categoryId => text()(); // Categoría asignada/corregida por el usuario
  IntColumn get usageCount => integer().withDefault(const Constant(1))(); // Veces que se usó
  DateTimeColumn get lastUsed => dateTime()(); // Última vez que se usó esta regla
